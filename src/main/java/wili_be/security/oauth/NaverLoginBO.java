...
public class NaverLoginBO {
    ...
    public SocialMemberInfoDto getUserProfile(OAuth2AccessToken oAuth2AccessToken) throws IOException {
        OAuth20Service oAuth20Service = new ServiceBuilder()
                .apiKey(CLIENT_ID)
                .apiSecret(CLIENT_SECRET)
        ...
        SocialMemberInfoDto socialUserInfoDto = new SocialMemberInfoDto(id, name, email);
